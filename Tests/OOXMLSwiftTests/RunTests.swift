...
final class RunTests: XCTestCase {
    ...
    // (v1.0 task 6.3: the rawChildren positional-emit unit tests were
    // removed with the mechanism — unknown rPr children now live in the
    // tree, and reducer-refreshed dirty parts serialize the tree.)
}
