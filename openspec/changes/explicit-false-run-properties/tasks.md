...
- [x] 3.3 Verify PsychQuant/che-word-mcp#197 against frozen `563039c`: focused 2/2 and full 347 tests with 12 skips, 0 failures; draft PR #198 head `cd3e592` pins the exact revision pending release.
